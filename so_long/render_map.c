...
/*   Updated: 2025/01/10 11:33:38 by malaamir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_images(t_map *map)
{
    ...
    map->img_exit = mlx_xpm_file_to_image(map->mlx, "textures/door1.xpm", &map->img_width, &map->img_height);
    map->img_collectible = mlx_xpm_file_to_image(map->mlx, "textures/diam.xpm", &map->img_width, &map->img_height);
    map->img_player = mlx_xpm_file_to_image(map->mlx, "textures/player.xpm", &map->img_width, &map->img_height);
